 ...
 * Use the [IntegrityDefectFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class IntegrityDefectFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_integrity_defect, container, false)
